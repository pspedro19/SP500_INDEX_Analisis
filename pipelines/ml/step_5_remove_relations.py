...
def main():
    ...
    archivo_entrada = os.path.join(PROCESSED_DIR, "datos_economicos_1month_USDCOP_TRAINING.xlsx")
    archivo_salida = os.path.join(PROCESSED_DIR, "ULTIMO_USDCOP_final.xlsx")
