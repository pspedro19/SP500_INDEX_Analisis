...
def run_economic_data_processor(config_file=os.path.join(PROJECT_ROOT, 'data/Data Engineering.xlsx'),
                               output_file=os.path.join(PROJECT_ROOT, 'data/raw/0_raw/datos_economicos_procesados_cp.xlsx'),
                               data_root=os.path.join(PROJECT_ROOT, 'data/raw/0_raw'),
...
def ejecutar_myinvestingreportnormal(
    config_file=os.path.join(PROJECT_ROOT, 'data/Data Engineering.xlsx'),
    output_file=os.path.join(PROJECT_ROOT, 'data/raw/0_raw/datos_economicos_normales_procesados.xlsx'),
    data_root=os.path.join(PROJECT_ROOT, 'data/raw/0_raw'),
...
def run_fred_data_processor(
    config_file=os.path.join(PROJECT_ROOT, 'data/Data Engineering.xlsx'),
    output_file=os.path.join(PROJECT_ROOT, 'data/raw/0_raw/datos_economicos_procesados_Fred.xlsx'),
    data_root=os.path.join(PROJECT_ROOT, 'data/raw/0_raw'),
...
def ejecutar_otherdataprocessor(
    config_file=os.path.join(PROJECT_ROOT, 'data/Data Engineering.xlsx'),
    output_file=os.path.join(PROJECT_ROOT, 'data/raw/0_raw/datos_economicos_other_procesados.xlsx'),
    data_root=os.path.join(PROJECT_ROOT, 'data/raw/0_raw'),
...
def ejecutar_banco_republica_processor(
    config_file=os.path.join(PROJECT_ROOT, 'data/Data Engineering.xlsx'),
    output_file=os.path.join(PROJECT_ROOT, 'data/raw/0_raw/datos_banco_republica_procesados.xlsx'),
    data_root=os.path.join(PROJECT_ROOT, 'data/raw/0_raw'),
...
class DANEExportacionesProcessor:
        ...
        def ejecutar_dane_exportaciones_processor(
            ...
            output_file=os.path.join(PROJECT_ROOT, 'data/raw/0_raw/datos_dane_exportaciones_procesados.xlsx'),
            data_root=os.path.join(PROJECT_ROOT, 'data/raw/0_raw'),
...
def ejecutar_dane_exportaciones_processor():
    ...
    output_file = os.path.join(PROJECT_ROOT, 'data/raw/0_raw/datos_dane_exportaciones_procesadas.xlsx')
    return processor.run(output_file)
